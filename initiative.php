...
<body class="">
    ...
    <section class="container my-5 py-3">
        <div class="row d-flex justify-content-center align-items-flex-start">
            <div class="col-lg-6 col-sm-12 d-flex flex-column" style="line-height: 37px;">
                ...
                <div class="mt-4">Additionally, we aim to contrihi*
                    at least
        ...
        <div class="row vh-70 poligon-shadow">
            <div class="col-4 poligon pent-gradient ">
                <div class="row d-flex flex-column justify-content-center align-items-center">
                    <div class="col-12">
                        <div>
                            <img src="./images/init-2.png" class="poligon-image" alt="" srcset="">
                        </div>
                    </div>
            ...
            <div class="col-4 poligon pent-gradient ">
                <div class="row d-flex flex-column justify-content-center align-items-center">
                    <div class="col-12">
                        <div>
                            <img src="./images/gausha.png" class="poligon-image" alt="" srcset="">
                        </div>
                    </div>
                    <div class="col-12 d-flex flex-column justify-content-center align-items-center text-light">
                        <div class="fs-3 border-bottom pb-3 fst-italic">
            ...
            <div class="col-4 poligon pent-gradient ">
                <div class="row d-flex flex-column justify-content-center align-items-center">
                    <div class="col-12">
                        <div>
                            <img src="./images/init-3.png" class="poligon-image" alt="" srcset="">
                        </div>
                    </div>
                    <div class="col-12 d-flex flex-column justify-content-center align-items-center text-light">
                        <div class="fs-3 border-bottom pb-3 fst-italic">
                        ...
                        <div class="fst-italic text-center" style="margin-left: 44px;margin-right: 102px;">
                            ...
                            provided. A key goal of ours is to provide technical and financial assistance to the less privileged and vulnerable.
                            <!-- A number of health 
    ...
    <section class="container my-5 py-3 mb-poligon-container" style="display: none;">
        <div class="row d-flex flex-column justify-content-center align-items-center pent-gradient">
            ...
            <div class="col-12 d-flex flex-column justify-content-center align-items-center text-light">
                <div class="fs-3 border-bottom pb-3 fst-italic my-3">
                    Education
                </div>
