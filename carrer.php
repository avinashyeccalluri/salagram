...
<html lang="en">
  ...
  <body class="">
    <header>
      <div
        class="crs-header-container d-flex flex-column justify-content-between p-4"
      >
    ...
    <section>
      <div class="row d-flex justify-content-between align-items-center">
        <div class="col-8 container">
          <div
            class="row d-flex justify-content-between align-items-center container px-5"
          >
            <div class="col-12">
              <div class="fs-1 orange-text">
                <strong
                  >Our
                  <div>Culture</div></strong
                >
              </div>
            </div>
        ...
        <div class="col-4">
          <img
            src="./images/customer_support.png"
            alt=""
            class="img-thumbnail"
          />
        </div>
    ...
    <section>
      <div
        class="row d-flex justify-content-between align-items-center orange-background"
      >
        <div class="col-4">
          <img
            src="./images/customer_support.png"
        ...
        <div class="col-8">
          <div
            class="row d-flex justify-content-between align-items-center text-light"
          >
            <div class="col-12">
              <div class="fs-1">
                <strong
                  >Career
                  <div>Growth</div></strong
                >
              </div>
            </div>
