    ...
    <section class="container my-lg-5">
        <div class="row">
            <div class="col-12 lh fs-3" style="line-height: 48px;">
                <strong>MS Angles</strong> are suitable for use in a variety of commercial and industrial applications. It is
                commonly used in construction, engineering, and fabrication activities, with Mild Steel
                Angles being the most commonly used steel structural item. The mild steel angle that we
                manufacture has <strong>high strength</strong> and is <strong>made from high-quality mild steel</strong>
            </div>
